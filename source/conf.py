...
htmlhelp_basename = 'Aithinker-chdoc'
...
latex_documents = [
    (master_doc, 'Aithinker-ch.tex', u'Aithinker-ch Documentation',
     u'xuhongv', 'manual'),
]
...
man_pages = [
    (master_doc, 'aithinker-ch', u'Aithinker-ch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Aithinker-ch', u'Aithinker-ch Documentation',
     author, 'Aithinker-ch', 'One line description of project.',
     'Miscellaneous'),
]
