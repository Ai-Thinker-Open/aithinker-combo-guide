...
👉 **[USAGE.md](./USAGE.md)** — 含目录结构、文档写作规范、翻译流程、RTD 部署、PDF 构建、常见问题排查等完整说明。
...
> **PDF 构建**：`.readthedocs.yaml` 已启用 `formats: all`。动图 GIF 在 HTML 中保留，PDF 使用同名 PNG（首帧），详见 [USAGE.md](./USAGE.md)。
